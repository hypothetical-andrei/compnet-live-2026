...
def main():
    p = argparse.ArgumentParser(
        description="Fetch latest email via IMAP and print basic fields"
    )
    ...
    p.add_argument("--search", default="ALL")

    args = p.parse_args()

    # SSL for implicit TLS port
    ...
    try:
        ...
        print("Message ID:", latest_id.decode())
